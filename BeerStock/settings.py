...
SECRET_KEY = '=$i1la-&amp;b0xhpx^o)b5viu694r*sl^^z34gtv0(xpgo7hc5c9m'
...
ROOT_URLCONF = 'BeerStock.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'BeerStock.wsgi.application'
#'BeerStock.wsgi.application'
